...
<body class="bg-body-tertiary">
    <?php if (isset($_SESSION['erro_login'])): ?>
        <div class="position-fixed d-flex justify-content-center start-50 translate-middle-x mb-5 z-3 bottom-0">
            <div id="alert-mensagem" class="alert alert-danger alert-dismissible small h-100" role="alert"">
                <div><span><i class="bi bi-exclamation-triangle"></i></span> <?= $_SESSION['erro_login'] ?></div>
